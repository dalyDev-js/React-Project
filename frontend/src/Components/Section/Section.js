      ...
      <div class="flex flex-wrap items-center">
        ...
        <div class="w-full md:w-7/12 lg:w-1/2">
          <div class="mx-8 mb-20 max-w-[520px] md:mb-0 2xl:ml-20">
            ...
            <Link
              to="/products"
              class="inline-flex items-center justify-center py-3 text-base font-medium text-center transition border border-dark dark:border-white px-7 text-dark dark:text-white hover:bg-dark hover:text-black dark:hover:bg-white dark:hover:text-dark">
              {translate.Shop}
            </Link>
          </div>
        </div>
