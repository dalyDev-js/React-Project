        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          {loading ? (
            <>
              <button
                type="submit"
                className="w-full flex justify-center gap-2 items-center text-white bg-green-700 hover:bg-green-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                <svg
                  aria-hidden="true"
                  class="w-6 h-6 text-gray-200 animate-spin dark:text-gray-600 fill-green-400"
                  viewBox="0 0 100 101"
                  fill="none"
